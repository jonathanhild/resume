...
\def\subtitle{Food Scientist \& Data Scientist}
...
\resumeSectionStart{
  \resumeProject{Recalls Dashboard}{@ \repo{https://github.com/jonathanhild/fdadashboard}{https://github.com/jonathanhild/fdadashboard}}{End-to-end project to build data dashboard from US and International food recall sources. Uses machine learning with NLP to classify recall events. Provides useful information for analysis of emerging hazards.}
...
\resumeSectionStart{
  ...
  \resumeEducation{Dataquest.io}{\href{https://app.dataquest.io/view_cert/G76HQZAT7X8UQNXKR3LR/}{\underline{Data Analyst in Python}}, \href{https://app.dataquest.io/view_cert/WUIZGHWAQ94B9MDZBW6V/}{\underline{Data Analyst in Python}}}{2020}
