...
\resumeEntryStart{
  ...
  \resumeItemListEnd{}
  \resumeEntryTD{FDA Dashboard}{\repo{https://github.com/jonathanhild/fdadashboard}{https://github.com/jonathanhild/fdadashboard}}
  \resumeItemListStart{
    \resumeItem{\tag{In Process} Plotly Dash dashboard for food safety risks from FDA publically-accessible datasets.}}
  \resumeItemListEnd}
\resumeEntryEnd{}
