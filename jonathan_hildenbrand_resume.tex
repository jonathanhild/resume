...
\def\subtitle{Data Analytics \& Data Science}
...
\resumeEntryStart{
  ...
  \resumeItemListEnd{}
  \resumeEntryTD{Recall Dashboard}{\repo{https://github.com/jonathanhild/fdadashboard}{https://github.com/jonathanhild/fdadashboard}}
  \resumeItemListStart{
    \resumeItem{\tag{In Process} Data dashboard using Plotly Dash of keyword trends in recall data from US and International APIs.}}
  \resumeItemListEnd}
\resumeEntryEnd{}
