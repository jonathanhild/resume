...
\resumeSectionStart{
  ...
  \resumeSubExperience{IT Specialist/Business Analyst}{May 2018 \textemdash{} Jan 2020}Data cleaning project using SQL and Python of 10+ years of company data for new ERP system. Model for automated creation of product BOMs. Developed reports for accounting, sales, and customer service. Improved server, database, and network architecture for increased uptime.
...
\resumeSectionStart{\resumeExperience{University of Idaho}{Laboratory Assistant}{May 2005 \textemdash{} May 2006}Research project in size exclusion chromatography of carbohydrate chain fractions in teff grains.}\resumeSectionEnd{}
...
\resumeSectionStart{
  ...
  \resumeSkill{Proficient in}{Data Analysis, Machine Learning \& Deep Learning, SQL, PostgreSQL, SQLite, Microsoft SQL Server, Microsoft Excel, Git, Regular Expressions, Web Scraping, Jira, Technical Writing, Linux Environments, Bash, LaTex}
  \resumeSkill{Familiar with}{Computer Vision, GANs, Autoencoders, Data Pipelines, Web Development, Tableau, Power BI, ERP Systems, IT, Accounting}
}
\resumeSectionEnd{}
...
\resumeSectionStart{
  ...
  \resumeProject{DarkLogoGAN}{@ \repo{https://github.com/jonathanhild/DarkLogoGAN}{github.com/jonathanhild/DarkLogoGAN}}{\tag{In Process}GAN model to generate death/black metal band logotypes based on user input text.}
