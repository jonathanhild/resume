...
\resumeSectionStart{
  \resumeSkill{Proficient in}{Python, SQL, Data Pipelines, Machine Learning \& Deep Learning, PostgreSQL, SQL Server, SQLite, Git, Excel, JIRA, Regular Expressions, Technical Writing}
  \resumeSkill{Familiar with}{Natural Language Processing, SpaCY, NLTK, Time Series Analysis, A/B Testing, Web Design, HTML/CSS/JS, Linux, Windows Server, Power BI, ERP Systems, C/C++, VBA}
}
\resumeSectionEnd{}
