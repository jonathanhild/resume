...
\def\subtitlelink{jonathanhild.github.io}
\def\subtitletext{jonathanhild.github.io}
...
\resumeSectionStart{
  ...
  \resumeProject{VargScore ML \tag{In Process}}{@ \repo{https://github.com/jonathanhild/vargscore}{github.com/jonathanhild/vargscore}}{NLP model with inference/training ML pipeline in Flask to find bigoted leanings in heavy metal music.}
...
\resumeSectionStart{\resumeExperience{Bridgetown Natural Foods}{QA Supervisor}{Nov 2011 \textemdash{} Apr 2012}Managed 6-person quality assurance and sanitation department. Assisted in SQF certification.}\vspace{-6pt}\resumeSectionEnd{}
...
% \resumeSectionStart{\resumeExperience{Lactalis American Group}{Quality Intern}{May 2006 \textemdash{} Aug 2006}Statistical analysis project to find sources of underweight finished products on mozzarella line.}\vspace{-6pt}\resumeSectionEnd{}
